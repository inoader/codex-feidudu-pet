Create one horizontal animation strip for Codex pet `meituan-feidudu`, state `failed`.
...
Specific choreography: remain seated with fat belly preserved, shoulders and ears droop slightly, eyes blink slowly then look down, short arms sink against belly, then recover toward first pose. No tears or floating symbols.
