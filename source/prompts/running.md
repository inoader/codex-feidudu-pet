Create one horizontal animation strip for Codex pet `meituan-feidudu`, state `running`.
...
Specific choreography: remain seated with feet anchored. Count or tap the fingers of one short paw with the other paw while concentrating, with small alternating head nods. Hands stay close to the upper belly. This is a busy calculating loop, not walking.
